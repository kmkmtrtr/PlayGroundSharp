...
| 37 | While a delayed submission is running, watch the prompt and bottom status bar | an indeterminate progress strip and running message remain visible above the prompt, and the status dot pulses until completion or cancellation |
